...
'''
		expect = '''Program([VarDecl(Id(sQK4), NumberType, None, ArrayLit(StringLit(OPpPH))), FuncDecl(Id(XKbn), [VarDecl(Id(xBZF), ArrayType([8.23, 62.09, 11.41], StringType), None, None), VarDecl(Id(Wo_), ArrayType([86.66], NumberType), None, None)], Return()), VarDecl(Id(nN_p), ArrayType([35.4], StringType), None, None), VarDecl(Id(ag8i), StringType, None, BooleanLit(False)), VarDecl(Id(tlkY), ArrayType([5.83, 95.14, 10.19], NumberType), None, ArrayLit(StringLit(cwZ)))])'''
...
'''
		expect = '''Program([FuncDecl(Id(nD), [VarDecl(Id(Xs), ArrayType([18.75, 73.83, 53.11], BoolType), None, None)], Block([])), FuncDecl(Id(JX1), [VarDecl(Id(NnK), StringType, None, None), VarDecl(Id(xrtk), NumberType, None, None), VarDecl(Id(wd), ArrayType([13.33, 61.42, 40.63], NumberType), None, None)], Block([If((Id(VP), CallStmt(Id(DPA2), [Id(NA0), NumLit(20.77), BooleanLit(True)])), [], CallStmt(Id(zbbW), []))])), VarDecl(Id(PlT), ArrayType([58.11, 98.6, 53.91], StringType), None, ArrayLit(BooleanLit(False)))])'''
...
func VYg (bool mD[37.16])
	return
'''
		expect = '''Program([FuncDecl(Id(gN4), [VarDecl(Id(p6), StringType, None, None), VarDecl(Id(X2), NumberType, None, None), VarDecl(Id(QT), StringType, None, None)], Return()), VarDecl(Id(I9a), ArrayType([12.02, 2.28, 21.09], NumberType), None, ArrayLit(BooleanLit(True))), FuncDecl(Id(VYg), [VarDecl(Id(mD), ArrayType([37.16], BoolType), None, None)], Return())])'''
...
'''
		expect = '''Program([VarDecl(Id(NKJ), ArrayType([44.43, 1.37], BoolType), None, ArrayLit(Id(ocK9))), VarDecl(Id(DWP), ArrayType([29.73], StringType), None, ArrayLit(NumLit(49.25))), VarDecl(Id(iU74), ArrayType([78.29, 92.04], StringType), None, None)])'''
...
func Pz (string GqE, bool nQ, number X3[42.31])
	return
'''
		expect = '''Program([VarDecl(Id(Xq), ArrayType([57.55, 42.74], NumberType), None, None), VarDecl(Id(jG), ArrayType([34.27, 63.93, 27.55], BoolType), None, ArrayLit(StringLit(aq))), FuncDecl(Id(Pz), [VarDecl(Id(GqE), StringType, None, None), VarDecl(Id(nQ), BoolType, None, None), VarDecl(Id(X3), ArrayType([42.31], NumberType), None, None)], Return())])'''
...
'''
		expect = '''Program([VarDecl(Id(Bi), ArrayType([11.84, 21.66, 87.57], BoolType), None, ArrayLit(Id(o2))), VarDecl(Id(C3xU), ArrayType([45.45], NumberType), None, ArrayLit(BooleanLit(True))), FuncDecl(Id(mEai), [VarDecl(Id(Yyv_), NumberType, None, None), VarDecl(Id(ZE), ArrayType([76.55, 28.61], BoolType), None, None), VarDecl(Id(c5), ArrayType([20.41, 18.17], NumberType), None, None)], Block([])), FuncDecl(Id(xmdp), [], Block([For(Id(FbLf), NumLit(55.13), BooleanLit(False), Return(StringLit(o))), VarDecl(Id(Asq), ArrayType([96.25], StringType), None, None), AssignStmt(ArrayCell(Id(ELF5), [NumLit(28.56), BooleanLit(False)]), ArrayLit(NumLit(96.74)))]))])'''
...
number KA[33.96]
'''
		expect = '''Program([VarDecl(Id(ez), ArrayType([6.36], NumberType), None, ArrayLit(Id(Cu))), VarDecl(Id(MET), ArrayType([58.38], BoolType), None, None), VarDecl(Id(vTBf), None, dynamic, ArrayLit(BooleanLit(False))), VarDecl(Id(KA), ArrayType([33.96], NumberType), None, None)])'''
...
bool ayF[26.01] <- ["cdvQ"]
'''
		expect = '''Program([FuncDecl(Id(IRxe), [VarDecl(Id(o_1), ArrayType([79.02, 53.42], NumberType), None, None)], Block([])), VarDecl(Id(wAz), ArrayType([28.39], StringType), None, ArrayLit(NumLit(94.39))), FuncDecl(Id(q3), [VarDecl(Id(IqAt), BoolType, None, None), VarDecl(Id(R2Z), ArrayType([4.81, 99.81], NumberType), None, None)], Return()), VarDecl(Id(wWh), ArrayType([24.33], BoolType), None, ArrayLit(BooleanLit(False))), VarDecl(Id(ayF), ArrayType([26.01], BoolType), None, ArrayLit(StringLit(cdvQ)))])'''
...
'''
		expect = '''Program([VarDecl(Id(bX), BoolType, None, None), VarDecl(Id(fvaj), ArrayType([36.82, 73.67], BoolType), None, ArrayLit(StringLit(WpS)))])'''
...
'''
	...
	def test_AST_501(self):
		input = """func foo ()
			...
			"""
		expect = """Program([FuncDecl(Id(foo), [], Block([If((BinaryOp(>, Id(x), NumLit(0.0)), If((BinaryOp(>, Id(y), NumLit(0.0)), Block([CallStmt(Id(printBoolean), [BinaryOp(>, BinaryOp(*, Id(x), Id(y)), NumLit(0.0))])])), [(BinaryOp(>, Id(z), NumLit(0.0)), CallStmt(Id(printBoolean), [BinaryOp(>, BinaryOp(*, Id(x), Id(z)), NumLit(0.0))]))], None)), [], None)]))])"""
	...
	def test_400(self): 
		...
		bool d <- true 
		"""
		expect = """Program([VarDecl(Id(a), None, var, NumLit(5.0)), VarDecl(Id(b), NumberType, None, NumLit(0.0324)), VarDecl(Id(c), StringType, None, StringLit(Hello)), VarDecl(Id(d), BoolType, None, BooleanLit(True))])"""
		self.assertTrue(TestAST.test(input,expect,400))
	...
	def test_402(self): 
		...
		"""
		expect = """Program([VarDecl(Id(a), NumberType, None, UnaryOp(-, NumLit(123456789.0)))])"""
	...
	def test_403(self): # CHANGED
		...
		"""
		expect = """Program([FuncDecl(Id(main), [], Block([VarDecl(Id(a), StringType, None, StringLit(Hello)), VarDecl(Id(b), StringType, None, StringLit(,world!)), VarDecl(Id(c), StringType, None, BinaryOp(..., Id(a), Id(b)))]))])"""
	...
	def test_404(self): 
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [VarDecl(Id(n), NumberType, None, None), VarDecl(Id(delta), NumberType, None, None)], Block([AssignStmt(Id(n), BinaryOp(+, Id(n), Id(delta))), Return()]))])"""
		self.assertTrue(TestAST.test(input,expect,404))

	def test_405(self): 
		input = """number abc
		"""
		expect = """Program([VarDecl(Id(abc), NumberType, None, None)])"""
		self.assertTrue(TestAST.test(input,expect,405))

	def test_406(self): 
		input = """number a[2,3]
		"""
		expect = """Program([VarDecl(Id(a), ArrayType([2.0, 3.0], NumberType), None, None)])"""
	...
	def test_407(self): 
		...
		number x <- 1.25
		"""
		expect = """Program([VarDecl(Id(a), NumberType, None, NumLit(1.0)), VarDecl(Id(b), NumberType, None, NumLit(2.0)), VarDecl(Id(x), NumberType, None, NumLit(1.25))])"""
		self.assertTrue(TestAST.test(input,expect,407))
	def test_408(self): 
		input = """number i <- 0
		"""
		expect = """Program([VarDecl(Id(i), NumberType, None, NumLit(0.0))])"""
	...
	def test_409(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [], Block([Return()]))])"""
	...
	def test_410(self): 
		...
		number x
		"""
		expect = """Program([VarDecl(Id(a), StringType, None, None), VarDecl(Id(x), NumberType, None, None)])"""
		self.assertTrue(TestAST.test(input,expect,410))
		
	def test_411(self):
		input = """bool a <- true
		"""
		expect = """Program([VarDecl(Id(a), BoolType, None, BooleanLit(True))])"""
		self.assertTrue(TestAST.test(input,expect,411))

	def test_412(self): 
		input = """number a[1] <- [2]
		"""
		expect = """Program([VarDecl(Id(a), ArrayType([1.0], NumberType), None, ArrayLit(NumLit(2.0)))])"""
	...
	def test_413(self): 
		...
		number b <- 20 + 30
		"""
		expect = """Program([VarDecl(Id(a), NumberType, None, BinaryOp(/, NumLit(1.0), NumLit(2.0))), VarDecl(Id(b), NumberType, None, BinaryOp(+, NumLit(20.0), NumLit(30.0)))])"""
	...
	def test_414(self): 
		...
		number c <- 0.23E+7
		"""
		expect = """Program([VarDecl(Id(a), NumberType, None, NumLit(12.0)), VarDecl(Id(b), NumberType, None, NumLit(0.0012)), VarDecl(Id(c), NumberType, None, NumLit(2300000.0))])"""
	...
	def test_415(self): 
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [VarDecl(Id(a), NumberType, None, None)], Block([CallStmt(Id(somefunc), [Id(b), Id(c)]), Return(BinaryOp(+, Id(a), UnaryOp(-, NumLit(2018.0))))]))])"""
	...
	def test_416(self): 
		...
		number a <- 10
		"""
		expect = """Program([VarDecl(Id(x), NumberType, None, None), FuncDecl(Id(foo), [], Block([Return(NumLit(0.0))])), VarDecl(Id(a), NumberType, None, NumLit(10.0))])"""
	...
	def test_417(self): 
		...
		"""
		expect = """Program([VarDecl(Id(x), NumberType, None, None), FuncDecl(Id(foo), [], Block([Return(NumLit(0.0))])), FuncDecl(Id(goo), [], Block([VarDecl(Id(i), StringType, None, None)]))])"""
		self.assertTrue(TestAST.test(input,expect,417))

	def test_418(self): 
		input = """number x <- 10 - (2 + 3 * 4) / 7
		"""
		expect = """Program([VarDecl(Id(x), NumberType, None, BinaryOp(-, NumLit(10.0), BinaryOp(/, BinaryOp(+, NumLit(2.0), BinaryOp(*, NumLit(3.0), NumLit(4.0))), NumLit(7.0))))])"""
		self.assertTrue(TestAST.test(input,expect,418))

	def test_419(self): 
		input = """bool x <- not ((2 < 3) and (3 < 4))
		"""
		expect = """Program([VarDecl(Id(x), BoolType, None, UnaryOp(not, BinaryOp(and, BinaryOp(<, NumLit(2.0), NumLit(3.0)), BinaryOp(<, NumLit(3.0), NumLit(4.0)))))])"""
	...
	def test_420(self):
		...
		"""
		expect = """Program([FuncDecl(Id(fact), [VarDecl(Id(a), NumberType, None, None)], Block([CallStmt(Id(writeNumber), [BinaryOp(+, Id(a), NumLit(2018.0))])])), FuncDecl(Id(main), [], Block([CallStmt(Id(fact), [NumLit(2018.0)])]))])"""
	...
	def test_421(self): 
		...
		"""
		expect = """Program([FuncDecl(Id(goo), [VarDecl(Id(a), NumberType, None, None), VarDecl(Id(b), NumberType, None, None)], Block([VarDecl(Id(c), None, var, BinaryOp(+, Id(a), BinaryOp(*, NumLit(2.0), Id(b)))), CallStmt(Id(writeNumber), [Id(c)])])), FuncDecl(Id(main), [], Block([CallStmt(Id(goo), [NumLit(3.0), NumLit(2.7)])]))])"""
	...
	def test_422(self): 
		...
		"""
		expect = """Program([FuncDecl(Id(goo), [VarDecl(Id(a), StringType, None, None), VarDecl(Id(N), NumberType, None, None)], Block([VarDecl(Id(i), NumberType, None, None), VarDecl(Id(s), StringType, None, StringLit()), For(Id(i), BinaryOp(>=, Id(i), Id(N)), NumLit(1.0), Block([AssignStmt(Id(s), BinaryOp(..., Id(s), ArrayCell(Id(a), [Id(i)])))])), Return(Id(s))])), FuncDecl(Id(main), [], Block([]))])"""
	...
	def test_498(self):
		...
		"""
		expect = """Program([FuncDecl(Id(goo), [], Block([For(Id(i), BinaryOp(>=, Id(i), Id(N)), NumLit(1.0), Block([AssignStmt(Id(s), NumLit(1.0))]))]))])"""
	...
	def test_425(self): 
		...
		"""
		expect = """Program([VarDecl(Id(a29872), BoolType, None, UnaryOp(not, BinaryOp(and, BinaryOp(<, NumLit(2.0), NumLit(3.0)), BinaryOp(<, NumLit(3.0), NumLit(4.0)))))])"""
	...
	def test_426(self): 
		input = """number a[12,3]
					number x
					"""
		expect = """Program([VarDecl(Id(a), ArrayType([12.0, 3.0], NumberType), None, None), VarDecl(Id(x), NumberType, None, None)])"""
		self.assertTrue(TestAST.test(input,expect,426))
	def test_427(self):
		input = """number a[3,4,5]
					number x <- -2.95
					"""
		expect = """Program([VarDecl(Id(a), ArrayType([3.0, 4.0, 5.0], NumberType), None, None), VarDecl(Id(x), NumberType, None, UnaryOp(-, NumLit(2.95)))])"""
	...
	def test_429(self): 
		...
		number k <- 12.3E-2
		"""
		expect = """Program([VarDecl(Id(i), NumberType, None, NumLit(20.0)), VarDecl(Id(j), NumberType, None, NumLit(30.0)), VarDecl(Id(k), NumberType, None, NumLit(0.123))])"""
	...
	def test_430(self): 
		...
		number j <- 30
		"""
		expect = """Program([VarDecl(Id(i), NumberType, None, NumLit(20.0)), VarDecl(Id(j), NumberType, None, NumLit(30.0))])"""
		self.assertTrue(TestAST.test(input,expect,430))
	def test_431(self): 
		input = """number x <- 20
		dynamic a <- x + 3.7
		"""
		expect = """Program([VarDecl(Id(x), NumberType, None, NumLit(20.0)), VarDecl(Id(a), None, dynamic, BinaryOp(+, Id(x), NumLit(3.7)))])"""
	...
	def test_432(self): 
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [VarDecl(Id(a), BoolType, None, None), VarDecl(Id(b), BoolType, None, None)], Block([]))])"""
		self.assertTrue(TestAST.test(input,expect,432))
	def test_433(self): 
		input = """bool test_bool <- false
		"""
		expect = """Program([VarDecl(Id(test_bool), BoolType, None, BooleanLit(False))])"""
	...
	def test_434(self): # Special func error
		...
		"""
		expect = """Program([VarDecl(Id(a), NumberType, None, NumLit(20.0)), FuncDecl(Id(foo), [VarDecl(Id(a), NumberType, None, None)], Block([AssignStmt(Id(a), BinaryOp(+, Id(a), NumLit(10.0)))])), FuncDecl(Id(main), [], Block([CallStmt(Id(foo), [Id(a_int)]), CallStmt(Id(writeNumber), [Id(a_int)])]))])"""
	...
	def test_435(self): # CHANGED
		...
		"""
		expect = """Program([VarDecl(Id(i), NumberType, None, NumLit(20.0)), VarDecl(Id(j), NumberType, None, NumLit(30.0)), VarDecl(Id(k), NumberType, None, NumLit(40.0)), FuncDecl(Id(main), [], Block([AssignStmt(Id(i), BinaryOp(+, Id(j), Id(k))), CallStmt(Id(writeNumber), [Id(i)])]))])"""
	...
	def test_436(self): 
		...
		"""
		expect = """Program([VarDecl(Id(i), StringType, None, StringLit(Hello,)), VarDecl(Id(j), StringType, None, StringLit('"this '")), VarDecl(Id(k), StringType, None, StringLit('"world!'")), FuncDecl(Id(main), [], Block([AssignStmt(Id(t), BinaryOp(..., Id(i), Id(j))), CallStmt(Id(writeString), [Id(t)])]))])"""
	...
	def test_437(self): 
		...
		"""
		expect = """Program([VarDecl(Id(i), StringType, None, StringLit(Baba)), VarDecl(Id(j), StringType, None, StringLit(Mama)), FuncDecl(Id(main), [], Block([AssignStmt(Id(k), BinaryOp(..., Id(j), Id(i))), AssignStmt(Id(t), BinaryOp(..., BinaryOp(..., Id(k), Id(j)), Id(i))), AssignStmt(Id(l), BinaryOp(..., Id(k), BinaryOp(..., Id(j), Id(i)))), CallStmt(Id(writeString), [Id(t)]), CallStmt(Id(writeString), [Id(l)])]))])"""
	...
	def test_438(self): 
		...
		"""
		expect = """Program([FuncDecl(Id(main), [], Block([AssignStmt(ArrayCell(Id(a), [BinaryOp(+, NumLit(3.0), NumLit(5.0)), BinaryOp(*, NumLit(2.0), Id(x))]), BinaryOp(-, ArrayCell(Id(y), [NumLit(4.0)]), NumLit(7.0))), Return()]))])"""
	...
	def test_439(self): 
		...
		"""
		expect = """Program([FuncDecl(Id(main), [], Block([AssignStmt(ArrayCell(Id(a), [NumLit(0.0)]), BinaryOp(+, CallExpr(Id(foo), [NumLit(2018.0)]), CallExpr(Id(goo), [NumLit(3.0)]))), Return()]))])"""
	...
	def test_440(self):
		...
		"""
		expect = """Program([VarDecl(Id(i), NumberType, None, NumLit(123.45)), VarDecl(Id(j), NumberType, None, NumLit(2.87e+22)), VarDecl(Id(k), NumberType, None, NumLit(2500000000.0))])"""
	...
	def test_442(self): 
		...
		"""
		expect = """Program([FuncDecl(Id(main), [], Block([AssignStmt(ArrayCell(Id(a), [NumLit(0.0)]), BinaryOp(+, BinaryOp(+, ArrayCell(Id(b), [NumLit(2.0), NumLit(3.0)]), CallExpr(Id(foo), [NumLit(2.0)])), BinaryOp(+, ArrayCell(Id(b), [NumLit(0.0), NumLit(1.0)]), CallExpr(Id(goo), [NumLit(1.0)])))), Return()]))])"""
	...
	def test_443(self):
		input = """number a <- 20
					var b <- a
					"""
		expect = """Program([VarDecl(Id(a), NumberType, None, NumLit(20.0)), VarDecl(Id(b), None, var, Id(a))])"""
		self.assertTrue(TestAST.test(input,expect,443))
	def test_444(self): 
		input = """number x[3] <- [1.0,2.0,3.0]
					number a <- x[0] + x[1] + x[2]
					"""
		expect = """Program([VarDecl(Id(x), ArrayType([3.0], NumberType), None, ArrayLit(NumLit(1.0), NumLit(2.0), NumLit(3.0))), VarDecl(Id(a), NumberType, None, BinaryOp(+, BinaryOp(+, ArrayCell(Id(x), [NumLit(0.0)]), ArrayCell(Id(x), [NumLit(1.0)])), ArrayCell(Id(x), [NumLit(2.0)])))])"""
		self.assertTrue(TestAST.test(input,expect,444))
	def test_445(self):
		input = """number x[2,3] <- [[1,5,8],[2,9,6]]
					number a <- x[0,0] + x[0,1] + x[0,2] - x[1,0] - x[1,1] - x[1,2]
					"""
		expect = """Program([VarDecl(Id(x), ArrayType([2.0, 3.0], NumberType), None, ArrayLit(ArrayLit(NumLit(1.0), NumLit(5.0), NumLit(8.0)), ArrayLit(NumLit(2.0), NumLit(9.0), NumLit(6.0)))), VarDecl(Id(a), NumberType, None, BinaryOp(-, BinaryOp(-, BinaryOp(-, BinaryOp(+, BinaryOp(+, ArrayCell(Id(x), [NumLit(0.0), NumLit(0.0)]), ArrayCell(Id(x), [NumLit(0.0), NumLit(1.0)])), ArrayCell(Id(x), [NumLit(0.0), NumLit(2.0)])), ArrayCell(Id(x), [NumLit(1.0), NumLit(0.0)])), ArrayCell(Id(x), [NumLit(1.0), NumLit(1.0)])), ArrayCell(Id(x), [NumLit(1.0), NumLit(2.0)])))])"""
	...
	def test_447(self): 
		...
		"""
		expect = """Program([VarDecl(Id(x), NumberType, None, None), VarDecl(Id(y), NumberType, None, None), VarDecl(Id(z), BoolType, None, None), FuncDecl(Id(goo), [VarDecl(Id(x), NumberType, None, None), VarDecl(Id(y), NumberType, None, None)], Block([])), VarDecl(Id(t), ArrayType([10.0], NumberType), None, None), FuncDecl(Id(foo), [], Block([])), VarDecl(Id(a), StringType, None, StringLit(Hello World))])"""
	...
	def test_448(self): 
		...
		var c <- "Hello" 
		"""
		expect = """Program([VarDecl(Id(a), None, var, NumLit(295000.0)), VarDecl(Id(b), None, var, BooleanLit(True)), VarDecl(Id(c), None, var, StringLit(Hello))])"""
	...
	def test_449(self): 
		...
		"""
		expect = """Program([FuncDecl(Id(foo1), [VarDecl(Id(a), NumberType, None, None)], Block([CallStmt(Id(super), [Id(x), Id(y), Id(z)])]))])"""
		self.assertTrue(TestAST.test(input,expect,449))
	def test_450(self):
		input = """number x <- 20
		number y <- 2 * x + 1
		"""
		expect = """Program([VarDecl(Id(x), NumberType, None, NumLit(20.0)), VarDecl(Id(y), NumberType, None, BinaryOp(+, BinaryOp(*, NumLit(2.0), Id(x)), NumLit(1.0)))])"""
	...
	def test_451(self):
		...
		"""
		expect = """Program([VarDecl(Id(i), StringType, None, StringLit(20)), VarDecl(Id(j), StringType, None, StringLit(30)), VarDecl(Id(k), StringType, None, StringLit(40)), FuncDecl(Id(main), [], Block([AssignStmt(Id(k), BinaryOp(..., Id(j), BinaryOp(..., Id(i), Id(t)))), CallStmt(Id(writeString), [Id(k)])]))])"""
	...
	def test_452(self):
		...
		"""
		expect = """Program([VarDecl(Id(x), NumberType, None, NumLit(65.0)), FuncDecl(Id(fact), [VarDecl(Id(n), NumberType, None, None)], Block([If((BinaryOp(==, Id(n), NumLit(0.0)), Return(NumLit(1.0))), [], Return(BinaryOp(*, Id(n), CallExpr(Id(fact), [BinaryOp(-, Id(n), NumLit(1.0))]))))])), FuncDecl(Id(inc), [VarDecl(Id(n), NumberType, None, None), VarDecl(Id(delta), NumberType, None, None)], Block([AssignStmt(Id(n), BinaryOp(+, Id(n), Id(delta)))])), FuncDecl(Id(main), [], Block([VarDecl(Id(delta), NumberType, None, CallExpr(Id(fact), [NumLit(3.0)])), CallStmt(Id(inc), [Id(x), Id(delta)]), CallStmt(Id(writeNumber), [Id(x)])]))])"""
		self.assertTrue(TestAST.test(input,expect,452))

	def test_453(self):
		input = """number a[2,3] <- [[1,2,3],[4,5,6]]
		"""
		expect = """Program([VarDecl(Id(a), ArrayType([2.0, 3.0], NumberType), None, ArrayLit(ArrayLit(NumLit(1.0), NumLit(2.0), NumLit(3.0)), ArrayLit(NumLit(4.0), NumLit(5.0), NumLit(6.0))))])"""
	...
	def test_454(self):
		...
		"""
		expect = """Program([FuncDecl(Id(fibo), [VarDecl(Id(n), NumberType, None, None)], Block([If((BinaryOp(<=, Id(n), NumLit(2.0)), Return(NumLit(1.0))), [], Return(BinaryOp(+, CallExpr(Id(fibo), [BinaryOp(-, Id(n), NumLit(1.0))]), CallExpr(Id(fibo), [BinaryOp(-, Id(n), NumLit(2.0))]))))])), FuncDecl(Id(main), [], Block([CallStmt(Id(writeNumber), [CallExpr(Id(fibo), [NumLit(20.0)])])]))])"""
	...
	def test_455(self):
		...
		"""
		expect = """Program([FuncDecl(Id(perfectNum), [VarDecl(Id(N), NumberType, None, None)], Block([If((BinaryOp(or, BinaryOp(or, BinaryOp(or, BinaryOp(or, BinaryOp(==, Id(N), NumLit(6.0)), BinaryOp(==, Id(N), NumLit(28.0))), BinaryOp(==, Id(N), NumLit(496.0))), BinaryOp(==, Id(N), NumLit(8128.0))), BinaryOp(==, Id(N), NumLit(33550336.0))), Block([Return(BooleanLit(True))])), [], None), Return(BooleanLit(False))]))])"""
	...
	def test_456(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [VarDecl(Id(a), NumberType, None, None)], Block([AssignStmt(Id(a), BinaryOp(+, Id(a), UnaryOp(-, NumLit(2018.0)))), Return(Id(a))])), FuncDecl(Id(main), [], Block([VarDecl(Id(a), NumberType, None, NumLit(2018.0)), AssignStmt(Id(a), BinaryOp(+, Id(a), CallExpr(Id(foo), [Id(a)]))), CallStmt(Id(readNumber), [])]))])"""
	...
	def test_457(self):
		...
		"""
		expect = """Program([VarDecl(Id(a), ArrayType([4.0], NumberType), None, None), FuncDecl(Id(main), [], Block([VarDecl(Id(i), NumberType, None, None), For(Id(i), BinaryOp(>=, Id(i), NumLit(4.0)), NumLit(1.0), Block([AssignStmt(ArrayCell(Id(a), [Id(i)]), CallExpr(Id(readNumber), [])), CallStmt(Id(writeNumber), [ArrayCell(Id(a), [Id(i)])])]))]))])"""
	...
	def test_458(self):
		...
		"""
		expect = """Program([VarDecl(Id(a), ArrayType([4.0], NumberType), None, None), FuncDecl(Id(main), [], Block([VarDecl(Id(i), NumberType, None, None), For(Id(i), BinaryOp(>=, Id(i), NumLit(4.0)), NumLit(1.0), Block([AssignStmt(ArrayCell(Id(a), [Id(i)]), BinaryOp(*, NumLit(3.0), CallExpr(Id(readNumber), []))), CallStmt(Id(writeNumber), [ArrayCell(Id(a), [Id(i)])])]))]))])"""
	...
	def test_459(self):
		...
		"""
		expect = """Program([FuncDecl(Id(main), [], Block([VarDecl(Id(a), ArrayType([100.0], NumberType), None, None), VarDecl(Id(i), NumberType, None, NumLit(0.0)), For(Id(i), BinaryOp(>=, Id(i), NumLit(100.0)), NumLit(1.0), Block([AssignStmt(ArrayCell(Id(a), [Id(i)]), CallExpr(Id(readNumber), [])), If((BinaryOp(==, BinaryOp(%, ArrayCell(Id(a), [Id(i)]), NumLit(2.0)), NumLit(0.0)), Block([AssignStmt(ArrayCell(Id(a), [Id(i)]), BinaryOp(/, ArrayCell(Id(a), [Id(i)]), NumLit(2.0)))])), [], Block([AssignStmt(ArrayCell(Id(a), [Id(i)]), BinaryOp(+, BinaryOp(*, ArrayCell(Id(a), [Id(i)]), NumLit(3.0)), NumLit(1.0)))]))]))]))])"""
	...
	def test_460(self):
		...
		"""
		expect = """Program([FuncDecl(Id(main), [], Block([VarDecl(Id(a), ArrayType([100.0], NumberType), None, None), VarDecl(Id(i), NumberType, None, NumLit(0.0)), VarDecl(Id(n), NumberType, None, None), For(Id(i), BinaryOp(>=, Id(i), Id(n)), NumLit(1.0), Block([AssignStmt(ArrayCell(Id(a), [Id(i)]), CallExpr(Id(readNumber), [])), If((BinaryOp(==, BinaryOp(%, ArrayCell(Id(a), [Id(i)]), NumLit(2.0)), NumLit(0.0)), Block([AssignStmt(ArrayCell(Id(a), [Id(i)]), BinaryOp(/, ArrayCell(Id(a), [Id(i)]), NumLit(2.0)))])), [], Block([AssignStmt(ArrayCell(Id(a), [Id(i)]), BinaryOp(+, BinaryOp(*, ArrayCell(Id(a), [Id(i)]), NumLit(3.0)), NumLit(1.0)))]))]))]))])"""
	...
	def test_461(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [VarDecl(Id(a), ArrayType([10.0], NumberType), None, None)], Block([Return(Id(a))])), VarDecl(Id(b), NumberType, None, NumLit(20.0)), FuncDecl(Id(main), [], Block([Return()]))])"""
	...
	def test_462(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [VarDecl(Id(a), NumberType, None, None)], Block([If((BinaryOp(>, Id(a), NumLit(220.0)), Block([If((BinaryOp(==, BinaryOp(%, Id(a), NumLit(2.0)), NumLit(0.0)), Block([Return(Id(a))])), [], Block([Return(BinaryOp(+, Id(a), NumLit(1.0)))]))])), [], Block([Return(BinaryOp(+, Id(a), NumLit(10.0)))]))]))])"""
	...
	def test_463(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [], Block([If((BinaryOp(<, Id(a), Id(b)), If((BinaryOp(<, Id(c), Id(d)), CallStmt(Id(writeString), [StringLit(True)])), [], CallStmt(Id(writeString), [StringLit(False)]))), [], None)]))])"""
	...
	def test_464(self):
		...
		"""
		expect = """Program([VarDecl(Id(x), NumberType, None, NumLit(2018.0)), FuncDecl(Id(fact), [VarDecl(Id(n), NumberType, None, None)], Block([If((BinaryOp(==, Id(n), NumLit(0.0)), Return(NumLit(1.0))), [], Return(BinaryOp(*, Id(n), CallExpr(Id(fact), [BinaryOp(-, Id(n), NumLit(1.0))]))))])), FuncDecl(Id(decr), [VarDecl(Id(n), NumberType, None, None), VarDecl(Id(delta), NumberType, None, None)], Block([AssignStmt(Id(n), BinaryOp(-, Id(n), Id(delta)))])), FuncDecl(Id(main), [], Block([VarDecl(Id(delta), NumberType, None, CallExpr(Id(fact), [NumLit(32.0)])), CallStmt(Id(decr), [Id(x), Id(delta)]), CallStmt(Id(writeNumber), [Id(x)])]))])"""
	...
	def test_465(self):
		...
		"""
		expect = """Program([VarDecl(Id(x), NumberType, None, NumLit(2018.0)), FuncDecl(Id(fibo), [VarDecl(Id(n), NumberType, None, None)], Block([If((BinaryOp(<=, Id(n), NumLit(1.0)), Return(NumLit(1.0))), [], Return(BinaryOp(+, CallExpr(Id(fibo), [BinaryOp(-, Id(n), NumLit(1.0))]), CallExpr(Id(fibo), [BinaryOp(-, Id(n), NumLit(2.0))]))))])), FuncDecl(Id(decr), [VarDecl(Id(n), NumberType, None, None), VarDecl(Id(delta), NumberType, None, None)], Block([AssignStmt(Id(n), BinaryOp(-, Id(n), Id(delta)))])), FuncDecl(Id(main), [], Block([VarDecl(Id(delta), NumberType, None, CallExpr(Id(fact), [NumLit(100.0)])), CallStmt(Id(decr), [Id(x), Id(delta)]), CallStmt(Id(writeNumber), [Id(x)])]))])"""
	...
	def test_466(self):
		...
		dynamic y <- x * 0.25
		"""
		expect = """Program([VarDecl(Id(x), None, var, NumLit(20.0)), VarDecl(Id(y), None, dynamic, BinaryOp(*, Id(x), NumLit(0.25)))])"""
	...
	def test_467(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [VarDecl(Id(a), ArrayType([3.0], NumberType), None, None)], Block([Return(Id(a))]))])"""
		self.assertTrue(TestAST.test(input,expect,467))
	def test_468(self):
		input = """func foo() begin
		end
		"""
		expect = """Program([FuncDecl(Id(foo), [], Block([]))])"""
	...
	def test_469(self):
		...
		var t <- "It's me '"Hello'" "
		"""
		expect = """Program([VarDecl(Id(x), None, var, NumLit(2.0)), VarDecl(Id(y), None, var, BooleanLit(False)), VarDecl(Id(z), None, var, BooleanLit(True)), VarDecl(Id(t), None, var, StringLit(It's me '"Hello'" ))])"""
	...
	def test_470(self): 
		...
		dynamic u <- -1.e23
		"""
		expect = """Program([VarDecl(Id(x), None, var, NumLit(2.0)), VarDecl(Id(y), None, var, BooleanLit(False)), VarDecl(Id(z), None, var, BooleanLit(True)), VarDecl(Id(t), None, var, StringLit(It's me '"Hello'" )), VarDecl(Id(u), None, dynamic, UnaryOp(-, NumLit(1e+23)))])"""
	...
	def test_471(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [VarDecl(Id(a), NumberType, None, None), VarDecl(Id(b), NumberType, None, None), VarDecl(Id(c), NumberType, None, None)], Block([CallStmt(Id(writeNumber), [BinaryOp(+, BinaryOp(+, Id(a), BinaryOp(*, NumLit(2.0), Id(b))), BinaryOp(*, NumLit(3.0), Id(c)))])]))])"""
	...
	def test_472(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [VarDecl(Id(a), NumberType, None, None), VarDecl(Id(b), NumberType, None, None), VarDecl(Id(c), NumberType, None, None)], Block([CallStmt(Id(writeNumber), [BinaryOp(+, BinaryOp(+, Id(a), BinaryOp(*, NumLit(2.0), Id(b))), BinaryOp(*, NumLit(3.0), Id(c)))])])), FuncDecl(Id(main), [], Block([CallStmt(Id(foo), [NumLit(2.0), NumLit(3.0), NumLit(4.0)])]))])"""
	...
	def test_473(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [VarDecl(Id(a), NumberType, None, None), VarDecl(Id(b), NumberType, None, None)], Block([VarDecl(Id(c), NumberType, None, NumLit(2018.0)), CallStmt(Id(writeNumber), [BinaryOp(+, BinaryOp(+, Id(a), BinaryOp(*, NumLit(2.0), Id(b))), BinaryOp(*, NumLit(3.0), Id(c)))])])), FuncDecl(Id(main), [], Block([CallStmt(Id(foo), [NumLit(2.0), NumLit(3.0)])]))])"""
	...
	def test_474(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [VarDecl(Id(a), NumberType, None, None), VarDecl(Id(b), NumberType, None, None)], Block([CallStmt(Id(writeNumber), [BinaryOp(+, Id(a), Id(b))]), Return()]))])"""
	...
	def test_475(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [VarDecl(Id(a), NumberType, None, None), VarDecl(Id(b), NumberType, None, None)], Block([VarDecl(Id(i), NumberType, None, Id(a)), For(Id(i), BinaryOp(>, Id(i), Id(b)), NumLit(1.0), Block([VarDecl(Id(c), NumberType, None, BinaryOp(+, Id(a), Id(i))), CallStmt(Id(writeNumber), [Id(c)])]))]))])"""
	...
	def test_476(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [], Block([If((BooleanLit(True), Block([If((UnaryOp(not, BooleanLit(True)), Block([])), [], Return())])), [], None), Return()]))])"""
	...
	def test_477(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [], Block([If((UnaryOp(not, BooleanLit(True)), Block([If((BooleanLit(True), Block([VarDecl(Id(a), NumberType, None, NumLit(10.0)), AssignStmt(Id(a), BinaryOp(+, Id(a), NumLit(1.0))), Return()])), [], Return())])), [], Block([VarDecl(Id(a), NumberType, None, NumLit(1.0)), CallStmt(Id(writeNumber), [Id(a)])]))]))])"""
	...
	def test_478(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [VarDecl(Id(a), ArrayType([10.0], NumberType), None, None)], Block([VarDecl(Id(i), NumberType, None, NumLit(0.0)), For(Id(i), BinaryOp(>=, Id(i), NumLit(10.0)), NumLit(1.0), Block([AssignStmt(ArrayCell(Id(a), [Id(i)]), BinaryOp(+, BinaryOp(*, ArrayCell(Id(a), [Id(i)]), NumLit(2.0)), NumLit(1.0)))])), Return(Id(a))]))])"""
	...
	def test_479(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [VarDecl(Id(N), NumberType, None, None), VarDecl(Id(i), NumberType, None, None)], Block([VarDecl(Id(j), NumberType, None, NumLit(0.0)), For(Id(j), BinaryOp(>=, Id(j), Id(i)), NumLit(1.0), Block([If((BinaryOp(==, BinaryOp(%, Id(N), Id(j)), NumLit(0.0)), Block([AssignStmt(Id(N), BinaryOp(-, Id(N), Id(j)))])), [], None)]))]))])"""
	...
	def test_480(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo1), [VarDecl(Id(N), NumberType, None, None), VarDecl(Id(i), NumberType, None, None)], Block([AssignStmt(Id(N), BinaryOp(*, Id(N), Id(i)))])), FuncDecl(Id(main), [], Block([VarDecl(Id(N), NumberType, None, NumLit(2018.0)), CallStmt(Id(foo1), [Id(N), NumLit(3.0)]), CallStmt(Id(writeNumber), [Id(N)])]))])"""
	...
	def test_481(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo1), [VarDecl(Id(s), StringType, None, None), VarDecl(Id(N), NumberType, None, None)], Block([VarDecl(Id(i), NumberType, None, NumLit(0.0)), For(Id(i), BinaryOp(>=, Id(i), Id(N)), NumLit(1.0), Block([VarDecl(Id(temp), StringType, None, ArrayCell(Id(s), [BinaryOp(-, BinaryOp(-, Id(N), Id(i)), NumLit(1.0))])), AssignStmt(ArrayCell(Id(s), [BinaryOp(-, BinaryOp(-, Id(N), Id(i)), NumLit(1.0))]), ArrayCell(Id(s), [Id(i)])), AssignStmt(ArrayCell(Id(s), [Id(i)]), Id(temp))]))]))])"""
	...
	def test_482(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo1), [VarDecl(Id(s), StringType, None, None), VarDecl(Id(N), NumberType, None, None)], Block([VarDecl(Id(i), NumberType, None, NumLit(0.0)), For(Id(i), BinaryOp(>=, Id(i), BinaryOp(/, Id(N), NumLit(2.0))), NumLit(1.0), Block([VarDecl(Id(temp), StringType, None, ArrayCell(Id(s), [BinaryOp(-, BinaryOp(-, Id(N), Id(i)), NumLit(1.0))])), AssignStmt(ArrayCell(Id(s), [BinaryOp(-, BinaryOp(-, Id(N), Id(i)), NumLit(1.0))]), ArrayCell(Id(s), [Id(i)])), AssignStmt(ArrayCell(Id(s), [Id(i)]), Id(temp))])), CallStmt(Id(writeString), [Id(s)])])), FuncDecl(Id(main), [], Block([CallStmt(Id(foo1), [StringLit(Hello,this is me), NumLit(17.0)])]))])"""
		self.assertTrue(TestAST.test(input,expect,482))

	def test_483(self):
		input = """number a <- foo(2018) + goo(2018)
		"""
		expect = """Program([VarDecl(Id(a), NumberType, None, BinaryOp(+, CallExpr(Id(foo), [NumLit(2018.0)]), CallExpr(Id(goo), [NumLit(2018.0)])))])"""
		self.assertTrue(TestAST.test(input,expect,483))
	def test_484(self): # redundant
		input = """func foo(number a, number b) begin
		end
		"""
		expect = """Program([FuncDecl(Id(foo), [VarDecl(Id(a), NumberType, None, None), VarDecl(Id(b), NumberType, None, None)], Block([]))])"""
	...
	def test_485(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [VarDecl(Id(a), NumberType, None, None), VarDecl(Id(b), NumberType, None, None)], Block([VarDecl(Id(i), NumberType, None, NumLit(0.0)), For(Id(i), BinaryOp(>=, Id(i), NumLit(5.0)), NumLit(1.0), Block([VarDecl(Id(x), NumberType, None, NumLit(10.0)), VarDecl(Id(y), NumberType, None, NumLit(20.0)), VarDecl(Id(z), NumberType, None, NumLit(30.0)), Return(BinaryOp(>, BinaryOp(+, BinaryOp(+, BinaryOp(+, Id(x), Id(a)), Id(y)), Id(b)), BinaryOp(+, BinaryOp(+, BinaryOp(+, Id(y), Id(a)), Id(z)), Id(b))))]))]))])"""
	...
	def test_486(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo1), [VarDecl(Id(a), NumberType, None, None), VarDecl(Id(b), NumberType, None, None)], Block([VarDecl(Id(c), NumberType, None, BinaryOp(+, Id(a), Id(b))), CallStmt(Id(writeNumber), [Id(c)])]))])"""
	...
	def test_487(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo2), [VarDecl(Id(a), NumberType, None, None)], Block([CallStmt(Id(writeString), [StringLit(Test)]), AssignStmt(Id(a), BinaryOp(+, Id(a), NumLit(1.0))), CallStmt(Id(writeNumber), [Id(a)])])), FuncDecl(Id(main), [], Block([CallStmt(Id(foo2), [NumLit(10.0)])]))])"""
	...
	def test_488(self):
		...
		bool c <- true
		"""
		expect = """Program([VarDecl(Id(a), BoolType, None, BooleanLit(True)), VarDecl(Id(b), BoolType, None, BooleanLit(False)), VarDecl(Id(c), BoolType, None, BooleanLit(True))])"""
	...
	def test_489(self): 
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [], Block([If((BooleanLit(True), Block([VarDecl(Id(a), NumberType, None, NumLit(10.0)), VarDecl(Id(b), NumberType, None, NumLit(20.0)), VarDecl(Id(c), NumberType, None, NumLit(30.0)), CallStmt(Id(writeNumber), [BinaryOp(+, BinaryOp(+, Id(a), Id(b)), Id(c))])])), [], Block([VarDecl(Id(x), NumberType, None, NumLit(230.0)), VarDecl(Id(y), NumberType, None, UnaryOp(-, NumLit(230.0))), CallStmt(Id(writeNumber), [BinaryOp(+, Id(x), Id(y))])]))]))])"""
		self.assertTrue(TestAST.test(input,expect,489))
	def test_490(self):
		input = """bool a_20 <- (2 < 3) < 4
		"""
		expect = """Program([VarDecl(Id(a_20), BoolType, None, BinaryOp(<, BinaryOp(<, NumLit(2.0), NumLit(3.0)), NumLit(4.0)))])"""
	...
	def test_491(self):
		...
		"""
		expect = """Program([FuncDecl(Id(foo), [VarDecl(Id(a), StringType, None, None), VarDecl(Id(b), NumberType, None, None)], Block([Return(BinaryOp(..., Id(a), ArrayCell(Id(a), [Id(b)])))]))])"""
	...
	def test_492(self):
		...
		"""
		expect = """Program([VarDecl(Id(x), NumberType, None, NumLit(65.0)), FuncDecl(Id(y), [VarDecl(Id(x), NumberType, None, None)], Return(BinaryOp(+, Id(x), NumLit(1.0)))), VarDecl(Id(z), NumberType, None, NumLit(65.2)), FuncDecl(Id(t), [VarDecl(Id(z), NumberType, None, None)], Return(BinaryOp(*, Id(z), NumLit(2.0)))), FuncDecl(Id(main), [], Block([VarDecl(Id(y), NumberType, None, CallExpr(Id(y), [Id(x)])), VarDecl(Id(t), NumberType, None, CallExpr(Id(t), [Id(z)])), CallStmt(Id(writeNumber), [Id(y)]), CallStmt(Id(writeNumber), [Id(t)])]))])"""
	...
	def test_493(self):
		...
		"""
		expect = """Program([FuncDecl(Id(main), [], Block([VarDecl(Id(a), ArrayType([2.0, 2.0], NumberType), None, None), VarDecl(Id(i), NumberType, None, NumLit(0.0)), VarDecl(Id(j), NumberType, None, NumLit(0.0)), For(Id(i), BinaryOp(>=, Id(i), NumLit(2.0)), NumLit(1.0), Block([For(Id(j), BinaryOp(>=, Id(j), NumLit(2.0)), NumLit(1.0), Block([AssignStmt(ArrayCell(Id(a), [Id(i), Id(j)]), CallExpr(Id(readNumber), []))]))]))]))])"""
	...
	def test_494(self):
		...
		"""
		expect = """Program([FuncDecl(Id(main), [], Block([VarDecl(Id(a), ArrayType([2.0, 2.0], NumberType), None, None), VarDecl(Id(i), NumberType, None, NumLit(0.0)), VarDecl(Id(j), NumberType, None, NumLit(0.0)), For(Id(i), BinaryOp(>=, Id(i), NumLit(2.0)), NumLit(1.0), Block([For(Id(j), BinaryOp(>=, Id(j), NumLit(2.0)), NumLit(1.0), Block([AssignStmt(ArrayCell(Id(a), [Id(i), Id(j)]), CallExpr(Id(readNumber), []))]))])), For(Id(i), BinaryOp(>=, Id(i), NumLit(2.0)), NumLit(1.0), Block([For(Id(j), BinaryOp(>=, Id(j), NumLit(2.0)), NumLit(1.0), Block([CallStmt(Id(writeNumber), [ArrayCell(Id(a), [Id(i), Id(j)])])]))]))]))])"""
	...
	def test_495(self):
		...
		"""
		expect = """Program([FuncDecl(Id(test), [VarDecl(Id(a), NumberType, None, None), VarDecl(Id(c), StringType, None, None)], Block([If((BinaryOp(>, Id(a), NumLit(2.0)), AssignStmt(Id(a), NumLit(3.0))), [(BinaryOp(>, Id(a), NumLit(3.0)), AssignStmt(Id(a), NumLit(4.0)))], None)]))])"""
	...
	begin
		...
		"""
		expect = """Program([FuncDecl(Id(main), [], Block([If((Id(a), CallStmt(Id(do), [Id(a)])), [(BinaryOp(=, Id(a), NumLit(2.0)), CallStmt(Id(do), [Id(b)]))], None)]))])"""
	...
	def test_497(self):
		...
		"""
		expect = """Program([FuncDecl(Id(test), [VarDecl(Id(a), NumberType, None, None), VarDecl(Id(c), StringType, None, None)], Block([If((BinaryOp(>, Id(a), NumLit(2.0)), AssignStmt(Id(a), NumLit(3.0))), [(BinaryOp(>, Id(a), NumLit(3.0)), AssignStmt(Id(a), NumLit(4.0)))], AssignStmt(Id(b), NumLit(5.0)))]))])"""
